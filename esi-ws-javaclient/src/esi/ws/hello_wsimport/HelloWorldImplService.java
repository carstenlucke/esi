 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://hello.ws.esi/", wsdlLocation = "http://localhost:9000/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://hello.ws.esi/", "HelloWorldImplService");
    ...
    public esi.ws.hello_wsimport.HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://hello.ws.esi/", "HelloWorldImplPort"), esi.ws.hello_wsimport.HelloWorld.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public esi.ws.hello_wsimport.HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello.ws.esi/", "HelloWorldImplPort"), esi.ws.hello_wsimport.HelloWorld.class, features);
    }
